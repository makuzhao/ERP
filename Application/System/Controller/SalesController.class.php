    ...
    public function add() {
        ...
        if (@$_GET['code'] != "") {
            ...
            if ($bar) {
                ...
                echo "<div class='form-group'> <label for='inputPassword3' class='col-sm-2 control-label'>错误提示</label>  <div class='col-sm-5' style='margin-top: 3px;' ><font style='color:red;font-size:20px;'>该商品已经下架，请去 <a href='" . U("System/Presell/add") . "'> 添加 </a> 数据即可销售</font></div></div>";
            }
        } else {
