...
Source Database       : db_9

Target Server Type    : MYSQL
Target Server Version : 50538
File Encoding         : 65001

Date: 2014-12-12 14:52:21
*/
...
CREATE TABLE `tb_shop` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `shop` varchar(255) DEFAULT NULL COMMENT '店名',
  `address` varchar(255) DEFAULT NULL COMMENT '地址',
  `people` varchar(255) DEFAULT NULL COMMENT '店主',
  `tel` varchar(255) DEFAULT NULL COMMENT '店主电话',
  PRIMARY KEY (`id`)
